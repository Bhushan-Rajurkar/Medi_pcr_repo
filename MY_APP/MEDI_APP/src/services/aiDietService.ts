    ...
    const exercises: CoreExerciseItem[] = [
      {
        ...
        duration: '15-20 Mins',
        routine: '5-7 rounds Surya Namaskar + Tadasana, Bhujangasana (Cobra), and Vrikshasana (Tree Pose)',
        benefits: 'Improves full-body flexibility, spine mobility, activates metabolism & core strength',
      },
      {
        name: 'Brisk Walking / Light Jogging',
        timing: `${morningTiming.split(' ')[0]} - 7:15 AM or ${eveningTiming}`,
        duration: '20-25 Mins',
        routine: 'Continuous brisk walking (3,000-4,000 steps) at a brisk pace with upright posture',
        benefits: 'Cardiovascular heart conditioning, healthy blood circulation & active calorie burn',
      },
      {
        ...
        benefits: 'Increases vital lung capacity, oxygenates bloodstream & balances nervous system',
      },
      {
        name: 'Mindfulness Meditation & Relaxation',
        ...
        benefits: 'Lowers cortisol/stress hormones, calms mental chatter & ensures deep restful sleep',
      },
    ];
